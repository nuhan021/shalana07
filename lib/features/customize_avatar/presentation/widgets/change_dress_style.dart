                ...
                child: Obx(() {
                  return Row(
                    children: List.generate(
                      controller.totalElements.value!.dress.elements.length,
                      (index) {
        ...
        Container(
          ...
          child: Row(
            children: [
              ...
              SizedBox(width: 10.w),
              Obx(() {
                final dressElement = controller
                    .totalElements
                    .value!
                    .dress
                    .elements[controller.selectedDressStyleIndex.value];
                final colorDetails = dressElement.colorDetails ?? [];
                return Expanded(
                  child: Row(
                    children: List.generate(
                      controller
