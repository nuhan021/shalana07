...
import '../../../profile/child/controller/child_profile_controller.dart';

class ChildCreateNewGoalController extends GetxController {
  ...
  void onInit() {
    ...
    selectedChild.value = controller.childModel.value!.data.id;
  }
  ...
  bool validCreateNewGoal() {
    ...
    if (selectedChild.value.isEmpty) {
  ...
  Future<void> createDailyNewGoad() async {
    ...
    final param = {
      ...
      "assignedChildIds": [selectedChild.value]
    };
