...
ChildLoginModel childModelFromJson(String str) => ChildLoginModel.fromJson(json.decode(str));

String childModelToJson(ChildLoginModel data) => json.encode(data.toJson());

class ChildLoginModel {
  bool success;
  String message;
  Data data;
  ...
  factory ChildLoginModel.fromJson(Map<String, dynamic> json) => ChildLoginModel(
